...
<body class="login-bg">
    ...
    <div class="login layui-anim layui-anim-up">
        <div class="message">后台管理系统&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="${pageContext.request.contextPath}/devLogin.html">APP开发者平台</a> </div>
        <div id="darkbannerwrap"></div>

        <form method="post" class="layui-form" action="${pageContext.request.contextPath}/backendLogin.do">
