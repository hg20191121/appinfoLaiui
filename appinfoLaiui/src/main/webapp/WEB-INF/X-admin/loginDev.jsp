...
<body class="login-bg">
    ...
    <div class="login layui-anim layui-anim-up">
        <div class="message">APP开发者平台&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="${pageContext.request.contextPath}/backendLogin.html">后台管理系统</a> </div>
        <div id="darkbannerwrap"></div>

        <form method="post" class="layui-form" action="${pageContext.request.contextPath}/devLogin.do" >
